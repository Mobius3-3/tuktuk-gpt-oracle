...
describe("tuktuk-gpt-oracle", () => {
  ...
  /*
    tuktuk -u https://api.devnet.solana.com -w ~/.config/solana/id.json task-queue create --name "tuktuk-gpt-oracle" --capacity 100   --min-crank-reward 1000000   --funding-amount 500000000 --stale-task-age 60400
  */
  const TASK_QUEUE = new PublicKey(
    "CZKGZZzXjwhoYAqumz2PEQFpbbwnNp9jPhARzrFhzGQx"
  );
